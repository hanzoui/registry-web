      ...
      handlers: [
        ...
        http.get(CAPI("/nodes/many-versions/versions"), () => {
          const versions = [
            ...
            {
              version: "4.9.1",
              changelog: "Critical security fixes and stability improvements",
              date: "2023-09-20T16:15:00Z",
            },
            {
              version: "4.9.0",
              changelog: "New animation features and improved UI controls",
              date: "2023-08-10T11:45:00Z",
            },
            {
              version: "4.8.3",
              changelog: "Bug fixes for memory leak and crash issues",
              date: "2023-07-25T09:20:00Z",
            },
            {
              version: "4.8.2",
              changelog: "Performance optimizations for large datasets",
            ...
            {
              version: "4.7.1",
              changelog: "Initial stable release with core features",
