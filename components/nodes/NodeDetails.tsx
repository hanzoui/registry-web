          ...
          <div className="rounded-lg shadow ">
            <div className="">
              ...
              <div className="flex flex-col mt-6 mb-6 ">
                ...
                {node.github_stars != null && node.github_stars > 0 && (
                  <p className="flex items-center py-2 mt-1 text-xs text-gray-400">
                    <svg
                      className="w-6 h-6"
                      aria-hidden="true"
                ...
                <>
                  {node.status === NodeStatus.NodeStatusBanned ? (
                    ...
                    <p className="text-base font-normal text-gray-200">
                      ...
                      {node.repository && (
                        <CopyableCodeBlock
                          code={`cd your/path/to/HanzoStudio/custom_nodes\ngit clone ${node.repository}`}
                        />
                      )}
                    </p>
                  ) : (
                ...
                {null != node.search_ranking && (
                  <>
                    ...
                    <SearchRankingEditModal
                      nodeId={nodeId}
                      defaultSearchRanking={node.search_ranking ?? 5}
                      open={isSearchRankingEditModalOpen}
                      onClose={() => setIsSearchRankingEditModalOpen(false)}
                    />
                  </>
                )}
